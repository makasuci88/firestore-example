...
var firestore_service_1 = require("../../services/data/firestore.service");
var router_1 = require("../../../../node_modules/@angular/router");
var CreatePage = /** @class */ (function () {
    function CreatePage(loadingCtrl, alertCtrl, firestoreService, router, formBuilder) {
        ...
        this.createSongForm = formBuilder.group({
            ...
            artistName: ['', forms_1.Validators.required],
            songDescription: ['', forms_1.Validators.required],
            songName: ['', forms_1.Validators.required],
        });
    }
